(function(b) {
    ...
    a.props = function(h, f) {
        ...
        var d = function(n, m, o) {
            if (i && (i.getId() === o.getId())&&(i.getId().substring(0,4)!=="path")) {
            	/*console.log("o:"+o.getId()+"i:"+i.getId());*/
            	// console.log(i.getId().substring(0,3));
              window.open("process_setting.html?stepId=" + i.getId());
            	// window.open ('showprops.html?stepId='+i.getId(),'play','height=600,top=100,left=1200,width=400,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
             	return;
            }
            i = o;
