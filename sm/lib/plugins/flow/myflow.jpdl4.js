...
$.extend(true,myflow.config.tools.states,{
	start : {
				...
				name : {text:'<<start>>'},
				text : {text:'开始'},
				img : {src : 'js/plugins/flow/img/48/start_event_empty.png',width : 48, height:48},
				...
				name : {text:'<<end>>'},
				text : {text:'结束'},
				img : {src : 'js/plugins/flow/img/48/end_event_terminate.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			'end-cancel' : {showType: 'image',type : 'end-cancel',
				...
				text : {text:'取消'},
				img : {src : 'js/plugins/flow/img/48/end_event_cancel.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			'end-error' : {showType: 'image',type : 'end-error',
				name : {text:'<<end-error>>'},
				text : {text:'错误'},
				img : {src : 'js/plugins/flow/img/48/end_event_error.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			state : {showType: 'text',type : 'state',
				name : {text:'<<state>>'},
				text : {text:'工序'},
				img : {src : 'js/plugins/flow/img/48/task_empty.png',width : 48, height:48},
				props : {
					text: {name:'text',label: '显示', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'工序'},
					temp1: {name:'temp1', label : '文本', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					temp2: {name:'temp2', label : '选择', value:'', editor: function(){return new myflow.editors.selectEditor([{name:'aaa',value:1},{name:'bbb',value:2}]);}}
				}},
			fork : {showType: 'image',type : 'fork',
				name : {text:'<<fork>>'},
				text : {text:'分支'},
				img : {src : 'js/plugins/flow/img/48/gateway_parallel.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
