...
$.extend(true,myflow.config.tools.states,{
	start : {
			...
			state : {type : 'state',
				...
				props : {
					num: {name:'text',label: '显示', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'工序'},
					name: {name:'name', label : '文本', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					descript: {name:'descript', label : '选择', value:'', editor: function(){return new myflow.editors.inputEditor();}}
				}},
			fork : {type : 'fork',
				name : {text:'<<fork>>'},
				text : {text:'分支'},
